...
const FB_API_VERSION = exports.FB_API_VERSION = 'v7.0';
...
const QUICK_REPLY_TYPES = exports.QUICK_REPLY_TYPES = ['text', 'location', 'user_phone_number', 'user_email'];
...
const TAGS = exports.TAGS = ['SHIPPING_UPDATE', 'RESERVATION_UPDATE', 'ISSUE_RESOLUTION', 'APPOINTMENT_UPDATE', 'GAME_EVENT', 'TRANSPORTATION_UPDATE', 'FEATURE_FUNCTIONALITY_UPDATE', 'TICKET_UPDATE', 'CONFIRMED_EVENT_REMINDER', 'COMMUNITY_ALERT', 'NON_PROMOTIONAL_SUBSCRIPTION', 'PAIRING_UPDATE', 'APPLICATION_UPDATE', 'ACCOUNT_UPDATE', 'PAYMENT_UPDATE', 'PERSONAL_FINANCE_UPDATE'];